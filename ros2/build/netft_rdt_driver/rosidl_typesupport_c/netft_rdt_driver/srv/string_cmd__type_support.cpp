...
static const _StringCmd_Request_type_support_symbol_names_t _StringCmd_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, netft_rdt_driver, srv, StringCmd_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, netft_rdt_driver, srv, StringCmd_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, netft_rdt_driver, srv, StringCmd_Request)() {
  return &::netft_rdt_driver::srv::rosidl_typesupport_c::StringCmd_Request_message_type_support_handle;
}
...
static const _StringCmd_Response_type_support_symbol_names_t _StringCmd_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, netft_rdt_driver, srv, StringCmd_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, netft_rdt_driver, srv, StringCmd_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, netft_rdt_driver, srv, StringCmd_Response)() {
  return &::netft_rdt_driver::srv::rosidl_typesupport_c::StringCmd_Response_message_type_support_handle;
}
...
static const _StringCmd_type_support_symbol_names_t _StringCmd_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, netft_rdt_driver, srv, StringCmd)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, netft_rdt_driver, srv, StringCmd)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, netft_rdt_driver, srv, StringCmd)() {
  return &::netft_rdt_driver::srv::rosidl_typesupport_c::StringCmd_service_type_support_handle;
}
